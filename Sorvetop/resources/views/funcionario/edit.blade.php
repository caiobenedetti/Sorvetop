...
<span style="font-size:20px">
    <i class='fa fa-database'></i> Alteração de dados de Funcionário</h1>
</span>
...
<form action="{{ route('funcionario.update', $funcionario->id) }}" method="post" role="form">
    {{ csrf_field() }}
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}"
                    id="nome" name="nome" placeholder="Nome do funcionário"
                ...
                <input type="text" class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}"
                    id="endereco" name="endereco" placeholder="Endereço do funcionário"
                ...
                <input type="text" class="form-control {{ $errors->has('telefone') ? 'is-invalid' : '' }}"
                    id="telefone" name="telefone" placeholder="Telefone do funcionário"
                ...
                <input type="number" class="form-control {{ $errors->has('salario') ? 'is-invalid' : '' }}"
                    id="salario" name="salario" placeholder="Salário do funcionário"
